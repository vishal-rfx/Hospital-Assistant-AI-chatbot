...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "GetCovidTestStatus" + "_" + process.env.ENV,
            
            
            "sampleUtterances": [
            
                "I would to know my covid test result? ",
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "Please enter your user reference ID provided by the hospital",
    ...
    let botName = "hospitalAssistantBot";
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "GetCovidTestStatus" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "b2b1052c",
